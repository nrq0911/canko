...
public class MybatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactory()throws Exception{
        ...
        //设置实体类的别名
        sqlSessionFactoryBean.setTypeAliasesPackage("com.canko.domain");
        //注册handler
        sqlSessionFactoryBean.setTypeHandlersPackage("com.canko.mapper.handler");
