function JsonFormater(opt) {
    this.options = $.extend({
        ...
        singleTab: "  ",
        quoteKeys: true,
        imgCollapsed: "/img/json/collapsed.gif",
        imgExpanded: "/img/json/expanded.gif",
        isCollapsible: true
    }, opt || {});
            ...
            if (obj == null) {
                ...
                if (numProps == 0) {
                    ...
                    for (prop in obj) {
                        ...
                        var numberHtml = this.ProcessObject(obj[prop], indent + 1, ++j < numProps, false, true);
                        numberHtml = markDiffPrice(obj, prop, numberHtml);
                        html += this.getRow(indent + 1, "<span class='jf-PropertyName'>" + quote + prop + quote + "</span>: " + numberHtml);
                    }
                    clpsHtml = this.options.isCollapsible ? "</span>" : "";
...
function markDiffPrice(obj, prop, numberHtml){
	try{
